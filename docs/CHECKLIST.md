...
- [ ] Exclusion list app-picker (currently manual bundle-ID entry) (PRV-1)
- [ ] Pause auto-resume timer (PRV-2)
- [ ] Clear-all history with confirmation (PRV-4)
- [ ] Optional secret-pattern filter, off by default (PRV-5)
